...
def extract_accelerometer_features(list_of_ids, mycursor,
    ...
    for one_id in list_of_ids:
        ...
        for i in range(1, noTest):
            ...
            if i == 1:
                ...
                listmean = list(map(add, listmean, feature_list))  # add new fft values for next signal to the previous ones
                # element by element
            a = a + 2999
...
def main():
    ...
    no_decimals = 10
    try:
        create_sql_table(mycursor, 'FEAT3', no_features, no_decimals)
    except mysql.connector.errors.ProgrammingError:
        print("Table already created")
    add_to_sql_command = generate_add_sql_command('FEAT3', no_features)
